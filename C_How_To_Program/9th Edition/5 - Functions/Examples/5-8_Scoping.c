...
void useGlobal(void); // functino prototype
...
int main(void) {
    ...
    { // start new scope
        int x = 7; // local varaible to new scope
    ...
    useLocal(); // useLocal has automatical local x
...
void useGlobal(void) {
    ...
    x *= 10;
    printf("global x is %d on exiting useGlboal\n", x);
}
